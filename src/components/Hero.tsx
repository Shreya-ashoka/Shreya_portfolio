    ...
    <div ref={introRef}>
      ...
      <section id="home" className="relative mx-auto flex max-w-5xl flex-col items-center px-6 pb-32 pt-40 text-center">
        ...
        <h2 className="home-reveal font-display text-5xl font-bold leading-[1.05] text-white sm:text-6xl md:text-7xl">
          ...
          <br />
          <span className="font-light italic text-[var(--color-muted)]">systems that think.</span>
        </h2>
        ...
        <p className="home-reveal mt-8 max-w-2xl text-balance text-base leading-relaxed text-[var(--color-muted)] sm:text-lg">
          ...
          Full-Stack Developer, and published researcher (Taylor &amp; Francis, IEEE). I turn complex problems
          into elegant AI solutions with Python, LLMs, and deep learning.
        </p>

        <div className="home-reveal mt-10 flex flex-wrap items-center justify-center gap-3">
          <a
            href="#projects"
            className="flex items-center gap-2 rounded-full bg-white px-6 py-3 text-sm font-semibold text-[#04050a] transition-transform hover:scale-105"
          >
            Explore My Work
            <ArrowRight size={15} />
          </a>
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center gap-2 rounded-full border border-[var(--color-border)] px-6 py-3 text-sm font-medium text-[var(--color-text)] transition-colors hover:border-[var(--color-cyan)]/50 hover:text-[var(--color-cyan-soft)]"
          >
